...
{
  "socials": ["google"],
  "passkey": { /* SimpleWebAuthn PublicKeyCredentialRequestOptions */ }
}
```
...
```json
{
  "email": "string",
  "duration": "SHORT | LONG",
  "webAuth": { /* SimpleWebAuthn RegistrationResponseJSON */ }
}
```
...
```json
{
  "email": "string",
  "duration": "SHORT | LONG",
  "webAuth": { /* SimpleWebAuthn AuthenticationResponseJSON */ }
}
```
...
```json
{
  "data": [{ "id": "uuid", "name": "string", "description": "string", "createdAt": "ISO8601" }]
}
```
  ...
  "data": [
    {
      ...
      "user_id": "uuid",
      "createdAt": "ISO8601",
      "user": { "id": "uuid", "display_name": "string", "profile_pic": "string?" }
    }
  ]
}
```
